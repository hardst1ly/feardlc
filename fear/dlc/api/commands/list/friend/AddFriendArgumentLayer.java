...
public class AddFriendArgumentLayer
extends ArgumentLayer {
    public AddFriendArgumentLayer() {
        super("add", 0);
    }

    public void execute(List<String> arguments) {
        if (arguments.isEmpty()) {
            this.printError("\u0418\u0441\u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u043d\u0438\u0435: .friend add <\u0438\u043c\u044f>");
            return;
        }
        String friendName = ((String)arguments.getFirst()).toLowerCase();
        if (FriendManager.isFriend(friendName)) {
            this.printError("\u0418\u0433\u0440\u043e\u043a " + friendName + " \u0443\u0436\u0435 \u0432 \u0441\u043f\u0438\u0441\u043a\u0435 \u0434\u0440\u0443\u0437\u0435\u0439!");
            return;
        }
        FriendManager.addFriend(friendName);
        this.printSuccess("\u0414\u0440\u0443\u0433 \u0434\u043e\u0431\u0430\u0432\u043b\u0435\u043d: " + friendName);
    }
}
